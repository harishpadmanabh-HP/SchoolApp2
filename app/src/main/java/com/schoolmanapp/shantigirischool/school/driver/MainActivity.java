...
/**
 * Created by srishtiinnovative on 18/07/17.
 */
...
//        markerOptions.icon(BitmapDescriptorFactory.fromResource(R.drawable.busnew));
...
public void onRequestPermissionsResult(int requestCode,
        ...
        public void onBackPressed() {
                appPreferences.saveDataBoolean("status",true);
