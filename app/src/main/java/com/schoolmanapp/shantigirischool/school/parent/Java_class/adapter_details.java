...
public class adapter_details extends BaseAdapter {
    ...
    List<model_fees.DataBean.PaidHistoryDataBean.PaidBillsDataBean> list;
...
//
    ...
    public adapter_details(Activity activity,List<model_fees.DataBean.PaidHistoryDataBean.PaidBillsDataBean> details) {
        mContext = activity;
        this.list = details;
    }
...
//        else
    ...
    public class Holder
    {
        TextView tv_slno,tv_particulars,tv_amt,tv_details;
...
//            holder.tv_slno.setText(position+1);
        ...
        //int discount=list.get(position).getPaidBillsData().get(0).getDiscount();
        int amt=list.get(position).getAmount();
        holder.tv_slno.setText(position+1+"");
        holder.tv_particulars.setText(part);
        holder.tv_particulars.setWidth(170);
        //    holder.tv_details.setText(discount+" %");
        holder.tv_amt.setText(amt+"");
        holder.tv_amt.setWidth(150);
